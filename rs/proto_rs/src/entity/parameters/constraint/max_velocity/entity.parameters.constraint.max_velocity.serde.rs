...
impl serde::Serialize for DoubleMaxVelocity {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("entity.parameters.constraint.max_velocity.DoubleMaxVelocity", len)?;
        if self.max != 0. {
...
impl<'de> serde::Deserialize<'de> for DoubleMaxVelocity {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct entity.parameters.constraint.max_velocity.DoubleMaxVelocity")
            }
        ...
        deserializer.deserialize_struct("entity.parameters.constraint.max_velocity.DoubleMaxVelocity", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ExprMaxVelocity {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("entity.parameters.constraint.max_velocity.ExprMaxVelocity", len)?;
...
impl<'de> serde::Deserialize<'de> for ExprMaxVelocity {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct entity.parameters.constraint.max_velocity.ExprMaxVelocity")
            }
        ...
        deserializer.deserialize_struct("entity.parameters.constraint.max_velocity.ExprMaxVelocity", FIELDS, GeneratedVisitor)
    }
}
